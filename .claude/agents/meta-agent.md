...
tools: Write, WebFetch, mcp__BrightData__scrape_as_markdown
color: Cyan
---
...
**5. add additional calling agent instructions to the Description:** like `When you prompt this agent, describe exactly what you want them to communicate to the user. Remember, this agent has no context about any questions or previous conversations between you and the user.`
...
- FIRST ACTION: Execute `qstart` to load project context, understand system requirements, and load relevant reference documents
- This ensures proper understanding of codebase structure, testing patterns, coding standards, and architectural decisions
- Follow all MUST rules and implementation best practices as loaded by the context initialization
